...
const DESC = 'SAROS compares programs, not molecules. A public ledger of clinical readouts — dates, sponsors, and signals — combining a large, filterable 2026–2028 landscape of thousands of trials (area × phase × modality, geography, sponsor domicile) with transparent heuristics and contextual financing signals, plus longevity and private-sponsor slices. Strictly public-data and non-advisory.';
const URL_ = 'https://saros.gcarosso.bio/';
const IMG = 'https://saros.gcarosso.bio/og-saros.png?v=2';
...
<meta name="author" content="Giovanni Carosso">
<link rel="author" href="https://gcarosso.bio/">
</head><body><h1>${TITLE}</h1><p>${DESC}</p><p><a href="${URL_}">Open the calendar</a> · <a href="${URL_}method">Method</a></p><p>Built and maintained by <a href="https://gcarosso.bio/">Giovanni Carosso</a>. Source on GitHub, Apache-2.0.</p></body></html>`;
